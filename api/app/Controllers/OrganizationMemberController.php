...
class OrganizationMemberController extends BaseController {
    ...
    public function update($params = []) {
        ...
        try {
            ...
            $this->logAudit('member_updated', 'OrganizationMember', $memberId,
    ...
    public function activate($params = []) {
        ...
        try {
            ...
            $this->logAudit('member_activated', 'OrganizationMember', $memberId,
    ...
    public function deactivate($params = []) {
        ...
        try {
            ...
            $this->logAudit('member_deactivated', 'OrganizationMember', $memberId,
                ['status' => $member['status']],
                ['status' => 'inactive']
            );
    ...
    // Get member's events (admin only)
