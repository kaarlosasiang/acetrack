  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-6xl mx-auto px-6 py-12">
            ...
            {Object.entries(colors).map(([key, color]) => (
              <Card key={key}>
                <CardContent className="p-6">
                  <div className={`w-full h-24 rounded-lg mb-4 ${color.className}`}></div>
        ...
        {/* Typography Section */}
        <section className="mb-16">
          <h2 className="text-4xl font-semibold text-[#1e1e1e] mb-8">Typography</h2>
        ...
        {/* Spacing Section */}
        <section className="mb-16">
          <h2 className="text-4xl font-semibold text-[#1e1e1e] mb-8">Spacing</h2>
        ...
        <section className="mb-16">
          <h2 className="text-4xl font-semibold text-[#1e1e1e] mb-8">Border Radius</h2>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {Object.entries(borderRadius).map(([name, radius]) => (
              <Card key={name}>
                <CardContent className="p-4">
                  <div className="flex items-center justify-center h-20 mb-4">
                    <div className={`w-12 h-12 bg-primary ${radius.className}`}></div>
                  </div>
        ...
        {/* Shadows Section */}
        <section className="mb-16">
          <h2 className="text-4xl font-semibold text-[#1e1e1e] mb-8">Shadows</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {Object.entries(shadows).map(([name, shadow]) => (
              <Card key={name}>
                <CardContent className="p-6">
                  <div className="flex items-center justify-center h-24 mb-4">
                    <div className={`w-16 h-16 bg-white border border-gray-200 rounded-lg ${shadow.className}`}></div>
                  </div>
        ...
        <section className="mb-16">
          <h2 className="text-4xl font-semibold text-[#1e1e1e] mb-8">Component Examples</h2>
        ...
        {/* Usage Guidelines */}
        <section className="mb-16">
          <h2 className="text-4xl font-semibold text-[#1e1e1e] mb-8">Usage Guidelines</h2>
            ...
            <Card className="border-green-200 bg-green-50">
              ...
              <CardContent>
                <ul className="space-y-2 text-green-700">
                  <li>• Use the primary color for main actions and brand elements</li>
                  <li>• Maintain consistent spacing using the defined scale</li>
                  <li>• Follow the typography hierarchy for content structure</li>
            ...
            <Card className="border-red-200 bg-red-50">
              ...
              <CardContent>
                <ul className="space-y-2 text-red-700">
                  ...
                  <li>• Don't skip heading levels in typography hierarchy</li>
                  <li>• Don't overuse shadows or high elevation</li>
                  <li>• Don't sacrifice accessibility for visual appeal</li>
                </ul>
              </CardContent>
            </Card>
          </div>
